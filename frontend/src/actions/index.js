...
export function fetchCategories() {
  return dispatch => {
    ...
    return DataAPI.getCategories().then(categories =>
...
export function fetchPosts(category = null) {
  return dispatch => {
    ...
    return DataAPI.getPosts(category).then(posts =>
...
export function fetchPostDetails(id) {
  return dispatch => {
    ...
    return DataAPI.getPostDetails(id).then(post =>
...
export function fetchPostComments(postId) {
  return dispatch => {
    ...
    return DataAPI.getPostComments(postId).then(comments =>
...
export function votePost(id, option) {
  return dispatch => {
    ...
    return DataAPI.votePost(id, option).then(post =>
      dispatch(receivePostDetails(post))
    );
  };
}
...
export function fetchCommentDetails(id) {
  return dispatch => {
    ...
    return DataAPI.getCommentDetails(id).then(comment =>
...
export function voteComment(id, option) {
  return dispatch => {
    ...
    return DataAPI.voteComment(id, option).then(comment =>
      dispatch(receiveCommentDetails(comment))
    );
  };
}
...
export function addPost(post) {
  return dispatch => {
    ...
    return DataAPI.addPost(post).then(post =>
      dispatch(receivePostDetails(post))
    );
  };
}
...
export function updatePost(id, post) {
  return dispatch => {
    ...
    return DataAPI.updatePost(id, post).then(post =>
      dispatch(receivePostDetails(post))
    );
  };
}
...
export function deletePost(id) {
  return dispatch => {
    ...
    return DataAPI.deletePost(id).then(post =>
      dispatch(receivePostDetails(post))
    );
  };
}
...
export function restorePost(post) {
  return dispatch => {
    ...
    return DataAPI.addPost(restoredPost).then(post =>
      dispatch(receivePostDetails(post))
    );
  };
}
...
export function addComment(comment) {
  return dispatch => {
    ...
    return DataAPI.addComment(comment).then(comment =>
...
export function updateComment(id, comment) {
  return dispatch => {
    ...
    return DataAPI.updateComment(id, comment).then(comment =>
      dispatch(receiveCommentDetails(comment))
    );
  };
}
...
export function deleteComment(id) {
  return dispatch => {
    ...
    return DataAPI.deleteComment(id).then(comment =>
      dispatch(receiveDeletedComment(comment))
    );
  };
}
...
export function restoreComment(comment) {
  return dispatch => {
    ...
    return DataAPI.addComment(restoredComment).then(comment =>
      dispatch(receiveCommentDetails(comment))
    );
  };
}
